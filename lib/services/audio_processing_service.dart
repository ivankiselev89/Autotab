...
class AudioProcessingService {
  ...
  /// [instrument] - Instrument type for filtering ('guitar', 'banjo', etc.)
  /// 
  ...
  Future<TranscriptionResult> processAudio({
    ...
    final tabNotation = _tabGenerator.generateTab(finalNotes, instrument: instrument);
...
''';
  ...
  /// Export as MIDI file
  Future<void> exportToMidi(String outputPath) async {
